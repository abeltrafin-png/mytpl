...
export default function InformasiList({ type }: InformasiListProps) {
  ...
  useEffect(() => {
    const fetchInformasi = async () => {
      try {
        ...
        const data: Informasi[] = await res.json();
        setInformasi(data);
      } catch (err: any) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Error Loading {type}</h2>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 capitalize">{type} Terbaru</h1>
      ...
      <div className="container mx-auto px-4 py-12">
        {informasi.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-2xl font-semibold text-gray-600 mb-2">Belum ada {type}</h3>
            <p className="text-gray-500">{type} akan segera ditampilkan di sini.</p>
          </div>
        ) : (
